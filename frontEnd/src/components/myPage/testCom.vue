            ...
            <div class="blog-detail-ct">
              ...
              >
                ...
                <div v-show="map">
                  ...
                  >
                    ...
                    <div style="margin: 25px">
                      <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3166.295338823776!2d126.8869551155937!3d37.47735637981467!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357b61e07310d561%3A0xadeb3944fef847ff!2z7ISc7Jq47Yq567OE7IucIOq4iOyynOq1rCDrlJTsp4DthLjroZwxMOq4uCA5!5e0!3m2!1sko!2skr!4v1672765208027!5m2!1sko!2skr"
                        width="450"
                        height="500"
                        style="border: 0"
                        allowfullscreen=""
                ...
                <div v-show="bus">
                  ...
                  >
                    ...
                    <div style="width: 480px; margin-left: 70px; float: right">
                      ...
                      <p style="margin-bottom: 0; color: black">
                        1번 출구 앞 시내 버스 정류장에서 5616, 5712 이용하여
                        [W몰] 정류장 하차 후 현대아울렛까지 도보 2분 이동 / 4번
                        출구에서 도보 600M 이동
                      </p>
                    </div>
                  </div>
                ...
                <div v-show="car">
                  ...
                  >
                    ...
                    <div style="width: 480px; margin-left: 70px; float: right">
                      ...
                      <p style="margin-bottom: 0; color: black">
                        서울시 금천구 디지털로 10길 9, 현대아울렛
                      </p>
                      <p style="margin-bottom: 0; color: black">
                        · 남부순환도로 공항 방면으로 시흥IC를 500M 지나,
                      </p>
                      <p style="margin-bottom: 0; color: black">
                        디지털단지 오거리를 건넌 후, 고가 아래에서 U턴 →
                        가산로를 따라 100M 이동 후, 지웰에스테이트 골목으로
                        우회전 → 현대아울렛 후문에서 좌회전
                      </p>
                    </div>
                  </div>
                ...
                <img
                  ...
                  src="@/assets/images_kim/Views/ModalView/CGVgangnam.jpg"
                  alt=""
                />
                <div
                  style="
                                          ...
                                          <div class="col-ms-10">
                                            ...
                                            <div class="user-infor col-ms-6">
                                              ...
                                              >
                                                ...
                                                <br>
                                                <br>
                                                <router-link to="/reserveTicket">{{ 가산디지털[0] }}</router-link>
                                                <br>
                                                <p>{{ data.showtm }}'</p>
                                              </div>
                                              <div
                                              ...
                                              >
                                                ...
                                                <br>
                                                <br>
                                                <router-link to="/reserveTicket">{{ 가산디지털[1] }}</router-link>
                                                <br>
                                                <p>{{ data.showtm }}'</p>
                                              </div>
                                              <div
                                              ...
                                              >
                                                ...
                                                <br>
                                                <br>
                                                <router-link to="/reserveTicket">{{ 가산디지털[2] }}</router-link>
                                                <p>{{ data.showtm }}'</p>
                                              </div>
                                            </div>
                                          </div>
...
export default {
  data() {
    return {
      ...
      가산디지털: ["10:30", "16:00", "19:30"], // 나중에 테스트 할 시간 데이터
