                  ...
                  <ul class="dropdown-menu level1">
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu level2">
                        <li><router-link to="/KasanCinema">가산디지털</router-link></li>
                        <li><router-link to="/GangdongCinema">강동</router-link></li>
                        <li><router-link to="/KonkukCinema">건대입구</router-link></li>
                      </ul>
                    </li>
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu level2">
                        ...
                        <li><router-link to="/CentumCinema">센텀시티</router-link></li>
