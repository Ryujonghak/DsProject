<template>
              ...
              <div class="blog-detail-ct">
                ...
                <div v-show="상영">
                  <div
                    ...
                    <button @click="seoul" class="div2">서 울</button>
                  ...
                  <div
                    ...
                    <div style="width: 1000px; height: 100px;">
                      <button
                        style="width: 60px; border-radius: 20px; height: 80px; float: left; margin: 10px;border: 0;  background-color: #071829;">
                        <h4 style="color: white; padding: 10px 0 0 13px;">{{ dd }}</h4>
                        <p style="margin-top: 15px">오늘</p>
                      </button>
                      <button
                        style="width: 60px; border-radius: 20px; height: 80px; float: left; margin: 10px;border: 0; background-color: #48545E;">
                      ...
                      <button
                        style="width: 60px; border-radius: 20px; height: 80px; float: left; margin: 10px;border: 0;  background-color: #48545E;">
                        <h4 style="padding: 10px 0 0 13px;">{{ dd + 4 }}</h4>
                        <p style="margin-top: 15px">{{ 요일[순서[4]] }}</p>
                      </button>
                      <button
                        style="width: 60px; border-radius: 20px; height: 80px; float: left; margin: 10px;border: 0;  background-color: #48545E;">
                        <h4 style="padding: 10px 0 0 13px;">{{ dd + 5 }}</h4>
                        <p style="margin-top: 15px">{{ 요일[순서[5]] }}</p>
                      </button>
                      <button
                        style="width: 60px;  border-radius: 20px;  height: 80px;  float: left;  margin: 10px; border: 0;background-color: #48545E; ">
                        <h4 style="padding: 10px 0 0 13px;">{{ dd + 6 }}</h4>
                        <p style="margin-top: 15px">{{ 요일[순서[6]] }}</p>
                      </button>
                      <button
                        style="width: 60px;  border-radius: 20px;  height: 80px;  float: left;  margin: 10px; border: 0;background-color: #48545E;">
                        <h4 style="padding: 10px 0 0 13px;">{{ dd + 7 }}</h4>
                        <p style="margin-top: 15px">{{ 요일[순서[0]] }}</p>
                      </button>
                    </div>
                    <div style=" border-bottom: 1px solid; margin: 0 15px; float: left; width: 40px;">
                      2D
                    </div>
                ...
                <div v-show="좌석">
                  <div style="margin-left: 50px;">
                    ...
                    <div style="color: white;float: right; margin-right: 110px;">
                      <img style="width: 30px; height: 30px" src="../assets/images_kim/free-icon-time-6659457.png"
                        alt="" />
                      <span> 러닝 타임 </span>
                    ...
                    <div style="width: 1020px; margin-bottom: 90px;">
                      <img style="margin: 10px 0; width: 1020px; height: 30px; box-shadow: 0 3px 10px rgba(255, 255, 255, 0.7);" src="../assets/images_kim/SCREEN.jpg" alt="" />
                    ...
                    <div style="margin-top: 20px">
                      <span style="color: white; margin: 9px"><img style="width: 13px; height: 13px;"
                          src="../assets/images_kim/seat-img1.jpg" alt="" />
                        선택 가능</span>
                      <span style="color: white; margin: 9px"><img style="width: 13px; height: 13px"
                          src="../assets/images_kim/seat-img2.jpg" alt="" />
                        선택 좌석</span>
                      <span style="color: white; margin-bottom: 19px"><img style="width: 13px; height: 13px"
                          src="../assets/images_kim/seat-img3.jpg" alt="" />
                        예매 완료</span>
                    </div>
  ...
  export default {
    ...
    methods: {
      ...
      // color() {
      //   if (this.요일[this.순서[0]] == this.요일[0]) {
      //     console.log("빨강");
      //   } else if (this.요일[this.순서[0]] == this.요일[6]) {
      //     console.log("파랑");
      //   } else {
      //     console.log("검정");
  
  
      //     if (this.요일[this.순서[1]] == this.요일[0]) {
      //       console.log("빨강");
      //     } else if (this.요일[this.순서[1]] == this.요일[6]) {
      //       console.log("파랑");
      //     } else {
      //       console.log("검정");
      //     }
      //     if (this.요일[this.순서[2]] == this.요일[0]) {
      //       console.log("빨강");
      //     } else if (this.요일[this.순서[2]] == this.요일[6]) {
      //       console.log("파랑");
      //     } else {
      //       console.log("검정");
      //     }
