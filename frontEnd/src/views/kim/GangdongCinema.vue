                  ...
                  <div v-show="map">
                      <div style="position: absolute; width: 500px; height: 600px; background-color: white; z-index: 30; left: 300px; top: -30px; border-radius: 10px; border: 1px solid ;">
                        ...
                        <div style="margin: 25px;">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d790.9451615601764!2d127.12500842924867!3d37.536667762184976!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca555f1b9725d%3A0x8b5848cca3a8a35e!2z66Gv642w7Iuc64Sk66eIIOqwleuPmQ!5e0!3m2!1sko!2skr!4v1672794262694!5m2!1sko!2skr" width="450" height="500" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                      </div>
                  </div>
                  <div v-show="bus">
                      <div style="position: absolute; width: 600px; height: 500px; background-color: white; z-index: 30; left: 300px; top: -30px; border-radius: 10px; border: 1px solid ;">
                        ...
                        <div style="width: 480px; margin-left: 70px; float: right; ">
                          ...
                          <p style="margin-bottom:0;color: black;"> · 간선버스 (B)</p>
                          <p style="margin-bottom:0;color: black;">130번 ,300번 ,361번 ,370번</p>
                          <p style="margin-bottom:0;color: black;"> · 지선버스 (G)</p>
                          <p style="margin-bottom:0;color: black;">3211번 ,3212번 ,3214번 ,3311번 ,3411번 ,3412번 ,3413번 ,4213번</p>
                          <p style="margin-bottom:0;color: black;"> · 광역버스 (R)</p>
                          <p style="margin-bottom:0;color: black;">9301번 ,606번</p>
                        </div>
                        <div style="width: 50px; height: 50px; float: left;">
                        ...
                        <div style="width: 480px; margin-left: 70px; float: right; ">
                          ...
                          <p style="margin-bottom:0;color: black;"> · 지하철 5호선 천호역 6번 출구</p>
                          <p style="margin-bottom:0;color: black;">지하철 5호선 천호역에서 하차하신 후 6번출구로 나오셔서 길동사거리 방면(출구 방향)으로 직진, 국민은행 오른쪽 골목으로 약 50미터 들어오시면 우측에 위치하고 있습니다.</p>
                  ...
                  <div v-show="car">
                      <div style="position: absolute; width: 600px; height: 200px; background-color: white; z-index: 30; left: 300px; top: 0ㅔㅌ; border-radius: 10px; border: 1px solid ;">
                        ...
                        <div style="width: 480px; margin-left: 70px; float: right; ">
                          ...
                          <p style="margin-bottom:0;color: black;"> · 서울특별시 강동구 천호옛길 85 (성내동)</p>
                        </div>
                      </div>
                  </div>
                  <img style="width:100%; margin-bottom: 0;" src="@/assets/images_kim/Views/ModalView/15549505447290.jpg" alt="">
                  <div style="background-color: black; opacity: 0.8; position: absolute; width: 100%; bottom: 0; left: 0; height: 250px;">
                      <div style="margin-left: 20px; margin-top: 20px;">
                          <h2 style="margin-bottom: 10px;">강동</h2>
                       <span > &nbsp;&nbsp;&nbsp; · 총 상영관 수 1개관 · 총 좌석수 97석</span>
                       <p style="margin: 0; margin-top: 10px; color: white; font-size: 18px; font-weight: bold;">서울 강동구 성내동,44-1</p>
                      </div>
